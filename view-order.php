          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <?php
                      $sl="SELECT id FROM order_items where order_items.order_id = $order";
                      $res = $conn->query($sl);
                      if($res-> num_rows > 0){
        ...
        <div class="justify-content-between align-items-center mb-2">
            <div>
              <p class="text">Product: 
                  <?php
                      $sql="SELECT product_name FROM order_items, product where id = $id and order_items.order_id = $order and order_items.product_id = product.prod_id";
                      $result = $conn->query($sql);
                      if($result-> num_rows > 0){
                      while($row = $result->fetch_assoc()){
            ...
            <div>
              <p class="text">Quantity: 
                  <?php
                      $sql="SELECT quantity FROM order_items where id = $id and  order_items.order_id = $order";
                      $result = $conn->query($sql);
                      if($result-> num_rows > 0){
                      while($row = $result->fetch_assoc()){
                      echo $row['quantity'];
            ...
            <div>
              <p class="text">Size: 
                  <?php
                      $sql="SELECT size_name FROM order_items, size where id = $id and order_items.order_id = $order and order_items.size=size.size_id";
                      $result = $conn->query($sql);
                      if($result-> num_rows > 0){
                      while($row = $result->fetch_assoc()){
                      echo $row['size_name'];
            ...
            <div>
              <p class="text">Color: 
                  <?php
                      $sql="SELECT color_name FROM order_items, colour where id = $id and order_items.order_id = $order and order_items.color=colour.color_id";
                      $result = $conn->query($sql);
                      if($result-> num_rows > 0){
                      while($row = $result->fetch_assoc()){
                      echo $row['color_name'];
            ...
            <div>
              <p class="text">Price: 
                  <?php
                      $sql="SELECT price FROM order_items where id = $id and order_items.order_id = $order";
                      $result = $conn->query($sql);
                      if($result-> num_rows > 0){
                      while($row = $result->fetch_assoc()){
                      echo $row['price'];
            ...
            <div>
              <p class="text">Total Price: 
                  <?php
                      $sql="SELECT total_price FROM order_items where id = $id and order_items.order_id = $order";
                      $result = $conn->query($sql);
                      if($result-> num_rows > 0){
                      while($row = $result->fetch_assoc()){
