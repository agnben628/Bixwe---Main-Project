...
<body>
              ...
              <div class="row tm-mt-big">
                    <div class="col-xl-20 col-lg-20 col-md-20 col-sm-20">
                        <div class="p-5 mb-20 bg-light text-dark">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="tm-block-title d-inline-block">Add Material</h2>
                                    <p id="d"></p>
                                </div>
                            </div>
                            <div class="row mt-4 tm-edit-product-row">
                                <div class="col-xl-15 col-lg-15 col-md-15">
                                    <form enctype='multipart/form-data' action="./manage-material.php" method="POST" class="tm-edit-product-form">
                                        <div class="input-group mb-3">
                                            <label for="c_name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5  col-form-label">Material</label>
                                        ...
                                        <div class="input-group mb-3">
                                            <label for="durability" class="col-xl-4 col-lg-4 col-md-4 col-sm-5  col-form-label">Durability</label>
                                            <input id="durability" name="durability" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" required pattern="^\S[a-zA-Z\s]*$">
                                        </div>
                                        <div class="input-group mb-3">
                                            <label for="comfort" class="col-xl-4 col-lg-4 col-md-4 col-sm-5  col-form-label">Comfort</label>
                                            <input id="comfort" name="comfort" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" required pattern="^\S[a-zA-Z\s]*$">
                                        </div>
                                        <div class="input-group mb-3">
                                            <label for="maintenance" class="col-xl-5 col-lg-5 col-md-5 col-sm-6  col-form-label">Maintenance</label>
                                            <input id="maintenance" name="maintenance" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" required pattern="^\S[a-zA-Z\s]*$">
                                        </div>
                                        <div class="input-group mb-3">
            ...
            <div class="table-responsive">
                    <table class="table">
                        <thead class="thead-light">
                            ...
                            <th scope="col" class="text-center">Durability</th>
                            <th scope="col" class="text-center">Comfort</th>
  ...
  <?php
    ...
    if(isset($_POST['upload']))
    {
        ...
        $material = $_POST['c_name'];
        $dur = $_POST['durability'];
        $com = $_POST['comfort'];
        $maint = $_POST['maintenance'];
       
        $insert = mysqli_query($conn,"INSERT INTO material (material_name, durability, comfort, maintenance) VALUES ('$material','$dur','$com','$maint' )");

        if($insert)
        {
            echo "<p id='d' style='color:white;'>" ."Material added succesfully"."</p>" ;
        }
        else
        {
            echo "<p id='d' style='color:white;'>" ."Could not add material"."</p>" ;
        }
