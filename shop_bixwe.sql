...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2023 at 08:49 PM
...
CREATE TABLE `cart` (
  ...
  `stock_status` int(5) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `cart` (`entry_id`, `user_id`, `product_id`, `size_id`, `color_id`, `price`, `cart_quantity`, `net_total`, `is_checked_out`, `stock_status`) VALUES
(82, 13, 14, 3, 1, 320, 1, 320, 1, 1),
(83, 13, 14, 5, 1, 320, 2, 640, 1, 1),
(84, 13, 14, 5, 1, 320, 1, 320, 1, 1),
(88, 13, 16, 3, 44, 449, 1, 449, 1, 1),
(89, 13, 16, 2, 8, 389, 2, 778, 1, 1),
(90, 13, 14, 3, 1, 320, 1, 320, 1, 1),
(92, 13, 16, 5, 8, 389, 1, 389, 1, 1),
(93, 13, 16, 7, 44, 389, 1, 389, 1, 1),
(94, 13, 14, 3, 1, 320, 1, 320, 1, 1),
(95, 13, 14, 5, 1, 350, 1, 350, 1, 1),
(96, 13, 14, 3, 1, 320, 1, 320, 1, 1),
(97, 13, 17, 13, 1, 755, 1, 755, 1, 1),
(98, 13, 16, 5, 44, 389, 1, 389, 1, 1),
(99, 13, 14, 3, 1, 320, 7, 2240, 1, 1),
(100, 13, 16, 3, 8, 449, 8, 3592, 1, 1),
(101, 13, 13, 5, 1, 731, 1, 731, 1, 1),
(102, 13, 13, 5, 1, 731, 1, 731, 1, 1),
(103, 13, 20, 3, 2, 419, 1, 419, 0, 1);
...
(46, 13, '2023-03-30', 'Agnes Benny', 'agnesbenny641@gmail.com', '7902934850', 3, '2', 8, 2944);
...
(57, 46, 13, 16, 1, 5, 1, 731, 731, 0),
(58, 46, 13, 16, 1, 5, 1, 731, 731, 0);
...
(7, 46, '827d35cdfcac86bd0a44eedffd1908d7'),
(8, 46, 'cfc1624d78f8adfa3476dc910e3bae55');
...
(33, 13, 5, 36, 17, 0, 0, 0, 0, 0, 0, 8, 731),
...
INSERT INTO `recommend` (`r_id`, `wear_id`, `o_desc`, `outfit`) VALUES
(1, 3, ' Women Floral Fit & Flare Dress ', '../recommendation/r1.jpg'),
(2, 3, 'Women Floral Printed Maxi Dress', '../recommendation/r2.jpg'),
(3, 3, 'Women Floral Printed Fit and Flare Dress', '../recommendation/r3.jpg'),
(4, 3, 'Women Floral Print Blouse Top', '../recommendation/r4.jpg'),
(5, 3, ' Women A-line Skirt', '../recommendation/r5.jpg'),
(7, 4, 'Women Drop Shoulder Midi Dress', '../recommendation/s1.jpg'),
(8, 4, 'Women Maroon Solid Sheath Dress', '../recommendation/s2.jpg'),
(9, 4, 'Women Sheath Dress', '../recommendation/s3.jpg'),
(10, 4, 'Women Trousers', '../recommendation/s4.jpg'),
(11, 4, 'Women Crop Top', '../recommendation/s5.jpg'),
(12, 1, 'Women Cigarette Trousers', '../recommendation/f1.jpg'),
(13, 1, 'Women Formal Pencil Skirt', '../recommendation/f2.jpg'),
(14, 1, 'Women Formal Shirt', '../recommendation/f3.jpg'),
(15, 1, 'Men Formal Shirt', '../recommendation/f4.jpg'),
(16, 1, 'Men Formal Suit', '../recommendation/f5.jpg'),
(17, 1, 'Men Trousers ', '../recommendation/f6.jpg'),
(18, 2, 'Women Casual Top', '../recommendation/c1.jpg'),
(19, 2, 'Women Blouse Top', '../recommendation/c2.jpg'),
(20, 2, 'Women Blouse Dress', '../recommendation/c3.jpg'),
(21, 2, 'Women Jeans', '../recommendation/c4.jpg'),
(22, 2, 'Men Casual Shirt', '../recommendation/c5.jpg'),
(23, 2, 'Men Jeans', '../recommendation/c6.jpg'),
(24, 5, 'Women Striped Dress', '../recommendation/g1.jpg'),
(25, 5, 'Women Shimmer & Sequin Dress', '../recommendation/g2.jpg'),
(26, 5, 'Women Velvet Dress', '../recommendation/g3.jpg'),
(27, 5, 'Women Glam Top', '../recommendation/g4.jpg'),
(28, 6, 'Women White Top', '../recommendation/m1.jpg'),
(29, 6, 'Women Blue Denim Sheath Dress', '../recommendation/m2.jpg'),
(30, 6, 'Women Bodycon Dress', '../recommendation/m3.jpg'),
(31, 3, 'Women Blouse Top', '../recommendation/blouse1.jpg'),
(32, 3, 'Women Blouse Top', '../recommendation/blouse2.jpg'),
(33, 3, 'Women Cami Top', '../recommendation/cam1.jpg'),
(34, 2, 'Women Cami Top', '../recommendation/cam2.jpg'),
(35, 8, 'Women Tube Top', '../recommendation/tube1.jpg'),
(36, 3, 'Women Tube Top', '../recommendation/tube2.jpg'),
(37, 10, 'Women Crop Top', '../recommendation/crop1.jpg'),
(38, 8, 'Women Crop Top', '../recommendation/crop2.jpg'),
(39, 7, 'Women Tunic Top', '../recommendation/tunic1.jpg'),
(40, 6, 'Women Tunic Top', '../recommendation/tunic2.jpg'),
(41, 2, 'Women Kaftan Top', '../recommendation/kaftan1.jpg'),
(42, 9, 'Women Kaftan Top', '../recommendation/kaftan2.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `rec_bodytype`
--

CREATE TABLE `rec_bodytype` (
  `entry_id` int(11) NOT NULL,
  `type_id` int(11) NOT NULL,
  `o_desc` varchar(200) NOT NULL,
  `outfit` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `rec_bodytype`
--

INSERT INTO `rec_bodytype` (`entry_id`, `type_id`, `o_desc`, `outfit`) VALUES
(1, 1, 'Abstract Printed Clinched Waist Tops regular shirt style tops\r\nAbstract print\r\nShirt collar, three-quarter, Cuffed Sleeve Tops \r\nWoven\r\nButton closure', '../rec_bodytype/pear1.jpg'),
(2, 1, 'Purple & Red Floral Print Layered Tops Peplum Tops Purple and red regular Peplum Tops\r\nFloral print\r\nV Neck Tops, long, puff sleeve tops sleeves\r\nLayered detail\r\nWoven', '../rec_bodytype/pear2.jpg'),
(3, 1, 'Women Classy Black Striped Wide Legged Trousers Flared Legged Trousers\r\nMid Rise Trousers', '../rec_bodytype/pear3.jpg'),
(4, 1, 'Bell Sleeve  Tops Crop Tops Square neck Tops, long bishop sleeve tops\r\nGathered tops pleated tops', '../rec_bodytype/pear5.jpg'),
(5, 1, 'Navy Blue & Red Checked Off-Shoulder Tops Crop Tops Cuffed Sleeve Tops', '../rec_bodytype/pear4.jpg'),
(6, 1, 'Pink Cold Shoulder Tops Ruffled Sleeve Tops Halter Neck Tops', '../rec_bodytype/pear6.jpg'),
(7, 1, ' Wrap Tops Crop Tops Structured Sleeve Tops', '../rec_bodytype/pear7.jpg'),
(8, 1, 'Women Blue Washed Cropped Jackets', '../rec_bodytype/pear8.jpg'),
(9, 1, 'Women Blue Tapered Trousers Pleated Trousers Mid Waisted Trousers', '../rec_bodytype/pear10.jpg'),
(10, 1, 'Trench Coats Double Breasted Coats', '../rec_bodytype/pear9.jpg'),
(11, 1, 'Relaxed Legged Trousers Straight Legged Trousers  High Waisted Trousers Boot Cut Trousers', '../rec_bodytype/pear11.jpg'),
(12, 1, 'Straight Cut Jeans Mid Waisted Jeans', '../rec_bodytype/pear12.jpg'),
(13, 1, 'Flared Cut Jeans High Waisted Jeans ', '../rec_bodytype/pear13.jpg'),
(15, 1, 'A-Line Skirts', '../rec_bodytype/pear14.jpg'),
(16, 1, 'Flared Skirts Knee Length Skirts', '../rec_bodytype/pear15.jpg'),
(17, 1, ' Hip Flare Dress', '../rec_bodytype/pear16.jpg'),
(18, 1, 'Wrap Dress', '../rec_bodytype/pear17.jpg'),
(19, 1, 'Tulip Dress Wrap Dress', '../rec_bodytype/pear18.jpg'),
(20, 1, 'Empire Line Dress A-Line Dress', '../rec_bodytype/pear19.jpg'),
(21, 1, 'Long Blazers', '../rec_bodytype/pear20.jpg'),
(22, 1, 'Hip Length  Tshirts', '../rec_bodytype/pear21.jpg'),
(23, 1, 'Hip Length Jumpers Chunky-Knit Jumpers', '../rec_bodytype/pear22.jpg'),
(24, 1, 'Chunky-Knit Jumpers Loose Fit Jumpers Hip Length Jumpers', '../rec_bodytype/pear23.jpg'),
(25, 2, 'Clinched Waist Top V Neck Crop Top', '../rec_bodytype/rect1.jpg'),
(26, 2, 'Ruffled Shoulder  Top Off Shoulder Top', '../rec_bodytype/rect2.jpg'),
(27, 2, 'Flared Sleeve Tops Clinched Waist Tops Round Neck Tops', '../rec_bodytype/rect3.jpg'),
(28, 2, 'Peplum Tops Puffed Sleeved Tops ', '../rec_bodytype/rect4.jpg'),
(29, 2, 'Puffed Sleeve Tops Belted Waist Tops Clinched Waist Tops', '../rec_bodytype/rect5.jpg'),
(30, 2, 'Round Neck Tops Belted Waist Tops Pleated Tops', '../rec_bodytype/rect6.jpg'),
(31, 2, 'Belted Waist Tops  Clinched Waist Tops Round Neck Tops', '../rec_bodytype/rect7.jpg'),
(32, 2, 'Belted Jackets Structured Jackets', '../rec_bodytype/rect9.jpg'),
(33, 2, 'Peplum Jackets', '../rec_bodytype/rect10.jpg'),
(34, 2, 'Straight Cut Jackets Structured Jackets', '../rec_bodytype/rect11.jpg'),
(35, 2, 'Double Breasted Jackets Structured Jackets', '../rec_bodytype/rect12.jpg'),
(36, 2, 'Long Cardigans', '../rec_bodytype/rect13.jpg'),
(37, 2, 'Trench Coats', '../rec_bodytype/rect14.jpg'),
(38, 2, 'Boot Cut Trousers Mid Waisted Trousers ', '../rec_bodytype/rect15.jpg'),
(39, 2, 'Flared Legged Trousers Mid Waisted Trousers ', '../rec_bodytype/rect16.jpg'),
(40, 2, 'Wide Legged Trousers Mid Waisted Trousers', '../rec_bodytype/rect17.jpg'),
(41, 2, 'Cargo Trousers', '../rec_bodytype/rect18.jpg'),
(42, 2, 'Boot Cut Jeans Slim Fit Jaans', '../rec_bodytype/rect19.jpg'),
(43, 2, 'Straight Cut Jeans', '../rec_bodytype/rect20.jpg');
...
(15, 'Zara', 'zara@gmail.com', '4a0eb8d1a084b36658c9df19b5f933cb', '7412589630', 'Seller', '', 0),
...
(26, 'Aishu Aish', 'aishu@gmail.com', '4a0eb8d1a084b36658c9df19b5f933cb', '9856230147', 'Customer', '', 1);
...
INSERT INTO `user_data` (`entry_id`, `username`, `email`, `weight`, `height`, `gender`, `body_type`) VALUES
(1, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(13, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(14, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(15, 'Rincy', 'rincy@gmail.com', 55, 155, 'Female', 'Rectangle'),
(16, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(17, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(18, 'Rincy', 'rincy@gmail.com', 55, 155, 'Female', 'Rectangle'),
(19, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(20, 'Aiswarya', 'aishu@gmail.com', 54, 155, 'Female', 'Rectangle'),
(21, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(22, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(23, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Rectangle'),
(24, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(25, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(26, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(27, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(28, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(29, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(30, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(31, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(32, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(33, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(34, 'Rincy', 'rincy@gmail.com', 55, 155, 'Female', 'Rectangle'),
(35, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear'),
(36, 'Agnes', 'agnesbenny641@gmail.com', 50, 150, 'Female', 'Pear');
...
INSERT INTO `wishlist` (`entry_id`, `product_id`, `user_id`, `brand_id`) VALUES
(43, 13, 13, 16),
(45, 14, 13, 15);
...
ALTER TABLE `recommend`
  ...
  ADD KEY `wearfk` (`wear_id`);

--
-- Indexes for table `rec_bodytype`
--
ALTER TABLE `rec_bodytype`
  ADD PRIMARY KEY (`entry_id`);
...
--
-- AUTO_INCREMENT for table `rec_bodytype`
--
ALTER TABLE `rec_bodytype`
  MODIFY `entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `user_data`
  MODIFY `entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `recommend`
  ADD CONSTRAINT `wearfk` FOREIGN KEY (`wear_id`) REFERENCES `wear` (`wear_id`);
