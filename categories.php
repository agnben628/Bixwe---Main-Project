            ...
            <div class="row tm-content-row tm-mt-big">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <h2 class="tm-block-title d-inline-block" style="color:white;">Categories</h2>
                    </div>
                    <div class="col-md-12 col-sm-12 text-left">
                                <a href="./add-category.php" class="btn btn-small btn-primary">Add New Category</a>
                            </div>
                </div>
                    ...
                    <table class="table mt-3">
                        <thead class="tm-bg-grey">
                            ...
                            ?>
                                    ...
                                    <td><a href="edit-category.php?id=<?=$row['category_id']?>" class="btn btn-small btn-primary">Edit</a></td>
                                    </tr>
                                    <?php
                                    $count=$count+1;
                                    }
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <h2 class="tm-block-title d-inline-block" style="color:white;">Sub Categories</h2>
                    </div>
                    <div class="col-md-12 col-sm-12 text-left">
                                <a href="./add-subcategory.php" class="btn btn-small btn-primary">Add New Sub Category</a>
                            </div>
                                </br>
                                </br>
                            <div>
