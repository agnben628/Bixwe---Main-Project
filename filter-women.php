  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <li class="nav-item">
                ...
                <ul class="navbar-nav mr-log-1">
                <?php
                                
        $sql="SELECT * from category,usergroup,subcategory where category.usergroup_id=3 and category.usergroup_id=usergroup.group_id and subcategory.category_id=category.category_id and subcategory.category_id=$cat";
        ...
        ?>    
                <li class="nav-item">
                        <a class="nav-link" href="filter-subcat.php?cat=<?=$row["sub_category_id"]?>"><?=$row["sub_category"]?></a>
                    </li>        
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <?php
      $sql="SELECT * from product,users,category where product.brand=users.user_id and product.category=$cat and product.category=category.category_id and product.usergroup=1";
      $result = $conn-> query($sql);
      if ($result-> num_rows > 0){
      while($row = $result-> fetch_assoc()){ 
