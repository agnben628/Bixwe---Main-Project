  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="row">
        <?php
      $sql="SELECT * from product,users,category where product.brand=users.user_id and product.category=$cat and product.category=category.category_id and product.usergroup=3";
      $result = $conn-> query($sql);
      if ($result-> num_rows > 0){
      while($row = $result-> fetch_assoc()){ 
