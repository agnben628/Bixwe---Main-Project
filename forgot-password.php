    ...
    if (mysqli_num_rows(mysqli_query($con, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {        
            ...
            try {
                ...
                $mail->Body    = 'Here is the verification link <b><a href="http://localhost/Bixwe/change-password.php?reset='.$code.'">http://localhost/Bixwe/change-password.php?reset='.$code.'</a></b>';
