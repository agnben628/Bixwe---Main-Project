...
$query=mysqli_query($conn,"SELECT * FROM address WHERE address_id= $id");
while($row=mysqli_fetch_array($query))
{
    ?>
<div class="input-group mb-3">
<label for="housename" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">House Name</label>
<input id="housename" name="housename" type="text" value="<?=$row['housename']?>" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"required pattern="^\S[a-zA-Z\s]*$">
</div>
<div class="input-group mb-3">
<label for="postoffice" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Post Office</label>
<input id="postoffice" name="postoffice" type="text" value="<?=$row['postoffice']?>" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"required pattern="^\S[a-zA-Z\s]*$">
</div>
<div class="input-group mb-3">
<label for="locality" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Locality</label>
<input id="locality" name="locality" type="text" value="<?=$row['locality']?>"class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"required pattern="^\S[a-zA-Z\s]*$">
</div>
<div class="input-group mb-3">
<label for="city" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">City</label>
<input id="city" name="city" type="text" value="<?=$row['city']?>"class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"required pattern="^\S[a-zA-Z\s]*$">
</div>
<div class="input-group mb-3">
<label for="district" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">District</label>
<input id="district" name="district" value="<?=$row['district']?>"type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"required pattern="^\S[a-zA-Z\s]*$">
</div>
<div class="input-group mb-3">
<label for="pincode" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Pincode</label>
<input id="pincode" name="pincode" type="text" value="<?=$row['pincode']?>" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"required >
</div>
<input hidden id="address" name="address" type="text" value="<?=$row['address_id']?>"  >
<?php } ?>
<div class="input-group mb-3">
    <div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0">
        <button type="submit" class="btn btn-dark" name="editaddress" id="upload">Update</button>
    </div>
</div>
</form>
                </div>
