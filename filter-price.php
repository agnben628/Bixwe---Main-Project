  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="row">
        <?php
      $sql="SELECT * from product, users, product_var where product.brand=users.user_id and product.prod_id=product_var.product_id and (product_var.price between $min and $max)";
      $result = $conn-> query($sql);
      if ($result-> num_rows > 0){
      while($row = $result-> fetch_assoc()){ 
