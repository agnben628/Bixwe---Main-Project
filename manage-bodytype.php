...
<body>
                        ...
                        <div class="p-5 mb-20 bg-light text-dark">
                            ...
                            <div class="row mt-4 tm-edit-product-row">
                                <div class="col-xl-15 col-lg-15 col-md-15">
                                    <form enctype='multipart/form-data' action="./manage-bodytype.php" method="POST" class="tm-edit-product-form">
                                        <div class="input-group mb-3">
                                            <label for="c_name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5  col-form-label">Body Type</label>
  ...
  <?php
    ...
    if(isset($_POST['upload']))
    {
        ...
        $insert = mysqli_query($conn,"INSERT INTO body_type (body_type) VALUES ('$type')");

        if($insert)
        {
            echo "<p id='d' style='color:white;'>" ."Body type added succesfully"."</p>" ;
        }
        else
        {
            echo "<p id='d' style='color:white;'>" ."Could not add body type"."</p>" ;
        }
