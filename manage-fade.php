...
<body>
              ...
              <div class="row tm-mt-big">
                    <div class="col-xl-20 col-lg-20 col-md-20 col-sm-20">
                        <div class="p-5 mb-20 bg-light text-dark">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="tm-block-title d-inline-block">Add Fade</h2>
                                    <p id="d"></p>
                                </div>
                            </div>
                            <div class="row mt-4 tm-edit-product-row">
                                <div class="col-xl-15 col-lg-15 col-md-15">
                                    <form enctype='multipart/form-data' action="./manage-fade.php" method="POST" class="tm-edit-product-form">
                                        <div class="input-group mb-3">
                                            <label for="c_name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5  col-form-label">Fade</label>
                    ...
                    <table class="table">
                        <thead class="thead-light">
                            ...
                            <th scope="col">S.N</th>
                            <th scope="col" class="text-center">Fade</th>
  ...
  <?php
    ...
    if(isset($_POST['upload']))
    {
        ...
        $fadename = $_POST['c_name'];
       
        $insert = mysqli_query($conn,"INSERT INTO fade (fade) VALUES ('$fadename')");

        if($insert)
        {
            echo "<p id='d' style='color:white;'>" ."Fade added succesfully"."</p>" ;
        }
        else
        {
            echo "<p id='d' style='color:white;'>" ."Could not add fade"."</p>" ;
        }
